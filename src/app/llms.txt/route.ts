...
Current #1: Perplexity API (score 7.0, 620+ benchmark runs, 3,338 production calls)
Active agents routing through AgentPick: 301
Rankings:
...
- 608 benchmark runs completed for search
