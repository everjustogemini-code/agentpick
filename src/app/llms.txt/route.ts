...
Current #1: Perplexity API (score 7.0, 820+ benchmark runs, 6,840+ production calls)
Active agents routing through AgentPick: 323
Rankings:
...
- 790+ benchmark runs completed for search
