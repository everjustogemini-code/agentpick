...
export const metadata: Metadata = {
  title: 'AI Agent API Benchmark Report — Week of March 14, 2026 — AgentPick',
  description:
    'Weekly AI agent API benchmark results: 536 runs across search, crawl, and retrieval APIs. Perplexity leads at 7.0, Haystack #2 at 6.9, Exa #3 at 6.4. Live rankings for AI agent tool selection.',
  openGraph: {
    title: 'AI Agent API Benchmark Report — March 14, 2026',
    description:
      '536 benchmark runs. Perplexity API #1 (7.0), Haystack #2 (6.9), Exa Search #3 (6.4). Weekly rankings for AI agent developers.',
    url: 'https://agentpick.dev/reports/weekly/2026-03-14',
    images: [{ url: '/api/og?type=benchmark&cap=search', width: 1200, height: 630 }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'AI Agent API Benchmark — Week of March 14, 2026',
    description: 'Perplexity #1 (7.0), Haystack #2 (6.9), Exa #3 (6.4). 536 benchmark runs.',
      ...
      <main className="mx-auto max-w-[700px] px-6 py-12">
        ...
        <header className="mb-10">
          <div className="mb-3 flex items-center gap-2">
            ...
            <span className="font-mono text-[11px] text-text-dim">March 14, 2026</span>
          </div>
          <h1 className="text-[30px] font-bold tracking-[-0.8px] text-text-primary leading-tight">
            AI Agent API Benchmark Report
          </h1>
          <p className="mt-3 text-base leading-relaxed text-text-secondary">
            536 benchmark runs across search, crawl, and retrieval APIs. Updated weekly from
          ...
          <div className="space-y-8 text-[15px] leading-relaxed text-text-secondary">
            ...
            <div className="rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                <div>
                  <div className="font-mono text-[22px] font-bold text-text-primary">536</div>
                  <div className="text-text-dim">Benchmark runs</div>
                </div>
                <div>
                  <div className="font-mono text-[22px] font-bold text-text-primary">2,036</div>
                  <div className="text-text-dim">Production calls</div>
                </div>
                <div>
                  <div className="font-mono text-[22px] font-bold text-text-primary">292</div>
            ...
            <div className="overflow-hidden rounded-xl border border-[#E2E8F0] bg-white shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
              <div className="px-5 py-4 border-b border-[#E5E5E5]">
                <h3 className="font-mono text-[10px] font-semibold uppercase tracking-wider text-text-dim">Search — 536 runs, week ending 2026-03-14</h3>
              </div>
            ...
            <div className="overflow-hidden rounded-xl border border-[#E2E8F0] bg-white shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
              <div className="px-5 py-4 border-b border-[#E5E5E5]">
                <h3 className="font-mono text-[10px] font-semibold uppercase tracking-wider text-text-dim">Crawl — week ending 2026-03-14</h3>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
            ...
            <div className="rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
              <ul className="space-y-2 text-sm">
                <li className="flex gap-2"><span className="text-text-dim font-mono">→</span> Perplexity API holds #1 — consistent across 4 weeks</li>
                <li className="flex gap-2"><span className="text-text-dim font-mono">→</span> Haystack stable at #2 — strong for RAG use cases</li>
                ...
                <li className="flex gap-2"><span className="text-text-dim font-mono">→</span> 292 active agents routing through AgentPick this week (+4 from last week)</li>
              </ul>
            </div>
...
# { "meta": { "tool_used": "perplexity-api" }, "data": { ... } }`}</pre>
            ...
            <div className="rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
              ...
              <p className="mb-3 text-sm text-text-secondary">
                Free tier: 500 calls/month. Routes to the current best API automatically.
              </p>
              <Link
                href="/connect"
        ...
        <footer className="mt-12 border-t border-[#E5E5E5] pt-8">
          ...
          <div className="space-y-3">
            ...
            <Link href="/blog/haystack-for-ai-agents" className="block text-sm font-semibold text-text-primary hover:text-[#0EA5E9]">
              Haystack for AI Agents: Why It Ranks #2 →
            </Link>
            <Link href="/blog/perplexity-api-for-ai-agents" className="block text-sm font-semibold text-text-primary hover:text-[#0EA5E9]">
              Perplexity API for AI Agents: When It Wins →
            </Link>
          </div>
        </footer>
