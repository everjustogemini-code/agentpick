...
export const metadata: Metadata = {
  title: 'AI Agent API Benchmark Report — Week of May 30, 2026 — AgentPick',
  description:
    'Weekly AI agent API benchmark results: 750+ runs across search, crawl, and retrieval APIs. Perplexity #1 at 7.0, Haystack #2 at 6.9, Exa #3 at 6.4. 315 active agents routing 399 calls/day.',
  openGraph: {
    title: 'AI Agent API Benchmark Report — May 30, 2026',
    description:
      '750+ benchmark runs. 315 active agents. Perplexity API #1 (7.0), Haystack #2 (6.9), Exa #3 (6.4). Valyu and Parallel entering final evaluation window. Weekly rankings for AI agent developers.',
    url: 'https://agentpick.dev/reports/weekly/2026-05-30',
    images: [{ url: '/api/og?type=benchmark&cap=search', width: 1200, height: 630 }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'AI Agent API Benchmark — Week of May 30, 2026',
    description: 'Perplexity #1 (7.0), Haystack #2 (6.9), Exa #3 (6.4). 750+ runs. 315 agents.',
      ...
      <main className="mx-auto max-w-[700px] px-6 py-12">
        ...
        <header className="mb-10">
          ...
          <p className="mt-3 text-base leading-relaxed text-text-secondary">
            750+ benchmark runs across search, crawl, and retrieval APIs. 315 active agents routing
        ...
        <article className="prose-blog">
          <div className="space-y-8 text-[15px] leading-relaxed text-text-secondary">
            ...
            <div className="rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
              <h3 className="mb-3 font-mono text-[10px] font-semibold uppercase tracking-wider text-text-dim">This Week at a Glance — May 24–30, 2026</h3>
              <div className="grid grid-cols-3 gap-4 text-sm">
                <div>
                  <div className="font-mono text-[22px] font-bold text-text-primary">750+</div>
                  <div className="text-text-dim">Benchmark runs</div>
                </div>
                <div>
                  <div className="font-mono text-[22px] font-bold text-text-primary">5,650+</div>
                  <div className="text-text-dim">Production calls</div>
                </div>
                <div>
                  <div className="font-mono text-[22px] font-bold text-text-primary">315</div>
            ...
            <div className="overflow-hidden rounded-xl border border-[#E2E8F0] bg-white shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
              <div className="px-5 py-4 border-b border-[#E5E5E5]">
                <h3 className="font-mono text-[10px] font-semibold uppercase tracking-wider text-text-dim">Search Rankings — Updated May 30, 2026</h3>
              </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-[#F5F5F5]">
                    <tr className="bg-[#F0FFF4]">
                      ...
                      <td className="px-5 py-3 font-mono text-text-dim">— stable (wk 12)</td>
                    </tr>
                    <tr>
                    ...
                    <tr className="bg-[#FFFBEB]">
                      ...
                      <td className="px-5 py-3 font-mono text-[#F59E0B]">evaluating (wk 8)</td>
                    </tr>
                    <tr className="bg-[#F0F9FF]">
                      ...
                      <td className="px-5 py-3 font-mono text-text-dim">evaluating (wk 9)</td>
                    </tr>
                    <tr className="bg-[#FFF7F0]">
                      ...
                      <td className="px-5 py-3 font-mono text-[#F97316]">evaluating (wk 5)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="overflow-hidden rounded-xl border border-[#E2E8F0] bg-white shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
              <div className="px-5 py-4 border-b border-[#E5E5E5]">
                <h3 className="font-mono text-[10px] font-semibold uppercase tracking-wider text-text-dim">Crawl Rankings — Updated May 30, 2026</h3>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
            ...
            <div className="space-y-4">
              <div className="rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
                ...
                <h3 className="mb-1 text-sm font-[650] text-text-primary">Top 5 rankings stable — 12 consecutive weeks</h3>
                <p className="text-sm text-text-secondary">
                  Perplexity (7.0), Haystack (6.9), Exa (6.4), Tavily (6.1), and Brave (5.8) have held
                  positions for 12 consecutive weeks. At 750+ benchmark runs, this is among the most
                  statistically robust search API rankings in the market. Consistent rankings mean
                  developers can confidently hardcode routing logic around these scores.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
                ...
                <h3 className="mb-1 text-sm font-[650] text-text-primary">315 active agents — 5,650+ cumulative calls</h3>
                <p className="text-sm text-text-secondary">
                  Registered agents reached 315 this week. Cumulative production routing calls crossed
                  5,650. Daily throughput holds at 399 calls/day. The router has now processed more
                  calls than any comparable open benchmark for search API selection — making AgentPick
                  rankings the most production-validated in the market.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
                ...
                <h3 className="mb-1 text-sm font-[650] text-text-primary">Valyu (wk 8) and Parallel Search (wk 9) — final evaluation window</h3>
                <p className="text-sm text-text-secondary">
                  Both Valyu Search (week 8) and Parallel Search (week 9) are in the final evaluation
                  window. Confirmed scores are expected in the next cycle. Valyu&apos;s high-precision
                  agentic retrieval and Parallel&apos;s token-compressed semantic search both target
                  use cases where the current top 5 leave gaps.{' '}
              ...
              <div className="rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
                ...
                <h3 className="mb-1 text-sm font-[650] text-text-primary">Firecrawl crawl evaluation — week 5, score imminent</h3>
                <p className="text-sm text-text-secondary">
                  Firecrawl&apos;s crawl evaluation enters week 5. JavaScript rendering performance on
                  SPA-heavy sites has held up consistently. A final placement in the top 3 crawl
                  rankings is expected this cycle.{' '}
            ...
            <div className="overflow-hidden rounded-xl border border-[#E2E8F0] bg-white shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
              <div className="px-5 py-4 border-b border-[#E5E5E5]">
                <h3 className="font-mono text-[10px] font-semibold uppercase tracking-wider text-text-dim">Week of May 24–30, 2026</h3>
              </div>
              <div className="divide-y divide-[#F5F5F5]">
                <div className="flex items-center justify-between px-5 py-3 text-sm">
                  <span className="text-text-dim">Total routed calls</span>
                  <span className="font-mono font-bold text-text-primary">5,650+</span>
                </div>
                <div className="flex items-center justify-between px-5 py-3 text-sm">
                ...
                <div className="flex items-center justify-between px-5 py-3 text-sm">
                  ...
                  <span className="font-mono font-bold text-text-primary">315</span>
                </div>
                <div className="flex items-center justify-between px-5 py-3 text-sm">
                  <span className="text-text-dim">Benchmark runs (total)</span>
                  <span className="font-mono font-bold text-text-primary">750+</span>
                </div>
              </div>
            </div>
