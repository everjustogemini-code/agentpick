...
const POSTS = [
  {
    ...
    description:
      'Brave has an independent index, costs $0.0008/call (7x cheaper than Perplexity), and leads on news freshness. When Brave beats the top-ranked search API — and when it does not.',
    date: '2026-03-14',
    readTime: '5 min',
    tag: 'Benchmark',
    tagColor: '#0EA5E9',
