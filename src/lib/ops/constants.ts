...
export const DOMAIN_DEFINITIONS: DomainDefinition[] = [
  ...
  { slug: "embedding", code: "embed", label: "Embedding", subdomains: ["passage-embed", "query-embed", "retrieval", "similarity"], suggestedTools: ["voyage-embed", "jina-embed", "edenai-embed"] },
];
